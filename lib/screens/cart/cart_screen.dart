                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      onPressed: cart.items.isEmpty ? null : () async {
                        ...
                        try {
                          // Show loading overlay if needed, but for now simple async
                          final userId = FirebaseAuth.instance.currentUser?.uid ?? 'anonymous';
                          final deliveryFee = _isPickup ? 150.00 : 0.00;
                          
                          final order = OrderModel(
                            id: '', // Generated by Firestore
                            orderId: 'Generating...', // Will be updated after save if needed
                            timeAgo: 'Just now',
                            orderDescription: '${cart.items.length} items from ${cart.shopName}',
                            userId: userId,
                            shopName: cart.shopName ?? 'Unknown Shop',
                            items: cart.items,
                            subTotal: cart.totalAmount,
                          ...
                          // Proceed to Progress Screen with real orderId
                          Navigator.push(
                            context,
                            MaterialPageRoute(
